...
class sayfa3Ekrani extends StatefulWidget {
  sayfa3Ekrani({Key? key}) : super(key: key);


  @override
  _sayfa3EkraniState createState() => _sayfa3EkraniState();
}

class _sayfa3EkraniState extends State<sayfa3Ekrani> {
  double secenek1= 4.0;
  double secenek2= 3.0;
  double secenek3= 3.0;
          ...
          child: Column(
            ...
            children: [
              Polls(children: [
                ...
                question: Text('Yurtdışında yaşamak ister miydiniz?'),
